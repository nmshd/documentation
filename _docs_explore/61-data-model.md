...
| value     | `IdentityAttributeValue`<!--[`IdentityAttributeValue`]({% link _docs_explore/65-attribute-values.md %}#identity-attribute-values)--> | The Attribute's value.                                                                                            |
...
| value           | `RelationshipAttributeValue`<!--[`RelationshipAttributeValue`]({% link _docs_explore/65-attribute-values.md %}#relationship-attribute-values -->                                                                                                                                                                                                                                                                                                                                                                                          | The Attribute's value.                                                                                                                                                                                                    |
