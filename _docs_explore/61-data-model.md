...
Identity Attributes describe an Identity itself. Their values are strongly normalized. There is a list of available values [here]({% link _docs_explore/65-attribute-values.md %}).
...
| value     | [`IdentityAttributeValue`]({% link _docs_explore/65-attribute-values.md %}#identity-attributes) | The Attribute's value.                                                                                            |
...
| value           | [`RelationshipAttributeValue`]({% link _docs_explore/65-attribute-values.md %}#relationship-attributes)                                                                                                                                                                                                                                                                                                                                                                                                                                   | The Attribute's value.                                                                                                                                                                                                    |
