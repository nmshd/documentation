...
| requireManualDecision | `boolean`               | To block the automated acceptance of Requests, the requireManualDecision property can be set to true. The default is, that each Request Item may be automatically processed on the peer side. If the sender would like to have an enforced manual acceptance step of for example an [AuthenticationRequestItem]({% link _docs_explore/64-request-items.md %}#authenticationrequestitem) or a [ConsentRequestItem]({% link _docs_explore/64-request-items.md %}#consentrequestitem), the requireManualDecision property can be set to true.                                                                                                                                                                                                                                                     |

There is a [dedicated site]({% link _docs_explore/64-request-items.md %}) that lists all available kinds of Request Items.
...
| Name  | Type                                | Description                                                                                                                                                                                                                      |
| ----- | ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| items | [`ResponseItem`](#responseitem)`[]` | The items inside of this Group. For each Request Item of the Request Item Group, there must be one Response Item in the Response Item Group. Note that the indicees have to be the same for matching Request and Response Items. |
...
Identity Attributes describe an Identity itself. Their values are strongly normalized. There is a list of available values here<!--[here]({% link _docs_explore/65-attribute-values.md %})-->.
...
| value           | `RelationshipAttributeValue`<!--[`RelationshipAttributeValue`]({% link _docs_explore/65-attribute-values.md %}#relationship-attribute-values -->                                                                                                                                                                                                                                                                                                                                                                                         | The Attriubte's value.                                                                                                                                                                                                    |
