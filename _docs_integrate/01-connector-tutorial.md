...
You can query the Connector's Address under the route `/api/v2/Account/IdentityInfo`. If you are using the Demo Connector of this Tutorial, the Address is `id15qFpUYHE4haXngaxUSXTG3SuheXJ7GwuZ`.
{: .notice--info}
