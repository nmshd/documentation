...
| consumption.<br>outgoingRequestFromRelationshipCreation<br>CreatedAndCompleted | [LocalRequest]({% link _docs_integrate/data-model-overview.md %}#LocalRequest)                 | ... a `consumption.`<br>`outgoingRequest`<br>`CreatedAndCompleted` event is fired and it was fired due to a newly created Relationship. This convenience event is especially useful to act on incoming pending Relationships.                                                                                                                                                                                                               |
