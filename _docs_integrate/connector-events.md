...
| transport.identityDeletionProcessStatusChanged                                 | [IdentityDeletionProcess]({% link _docs_integrate/data-model-overview.md %}#identitydeletionprocess) | ... a new IdentityDeletionProcess was self-initiated, triggered by the Backbone Admin UI or the status of an existing IdentityDeletionProcess has changed.                                                                                                                                                                                                                                                                                  |
