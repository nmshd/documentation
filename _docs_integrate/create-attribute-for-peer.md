...
| RelationshipAttribute | Third party |     ✗     | `N/A`           | A CreateAttributeRequestItem can only be used to request the creation of RelationshipAttributes that exist in the context of a Relationship between the Sender and the Recipient. For this reason, creating a RelationshipAttribute for the Recipient that is owned by a third party is not possible.                                                                                                                                                                                                                                                                                                                                                                                                      |
