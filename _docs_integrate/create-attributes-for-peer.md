...
Depending on whether an IdentityAttribute or a RelationshipAttribute is created and the ownership, it is referred to as either an [OwnRelationshipAttribute]({% link _docs_integrate/attribute-introduction.md %}#ownrelationshipattributes-and-peerrelationshipattributes) or a [PeerRelationshipAttribute]({% link _docs_integrate/attribute-introduction.md %}#ownrelationshipattributes-and-peerrelationshipattributes).
