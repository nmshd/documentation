...
- The [Get versions of Attribute]({% link _docs_use-cases/use-case-consumption-get-versions-of-an-attribute.md %}) and [Succeed RelationshipAttribute and notify peer]({% link _docs_use-cases/use-case-consumption-succeed-a-relationshipattribute-and-notify-peer.md %}) use cases were adjusted.
