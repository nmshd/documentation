...
- The nomenclature of [ThirdPartyRelationshipAttributes]({% link _docs_integrate/attribute-introduction.md %}#thirdpartyrelationshipattributes) has already changed in version 6.
