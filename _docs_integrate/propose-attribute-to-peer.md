...
| --------------------- | ----------- | :-------: | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| IdentityAttribute     | Sender      |     ✗     | `N/A`           | It makes no sense to propose own IdentityAttributes, use the [ShareAttributeRequestItem]({% link _docs_integrate/data-model-overview.md %}#shareattributerequestitem) instead.                                                                                                                                                                                |
...
| RelationshipAttribute | Sender      |     ✗     | `N/A`           | It makes no sense to propose own RelationshipAttributes, use the [CreateAttributeRequestItem]({% link _docs_integrate/data-model-overview.md %}#createattributerequestitem) or the [ReadAttributeRequestItem]({% link _docs_integrate/data-model-overview.md %}#readattributerequestitem) instead.                                                            |
...
| RelationshipAttribute | Third party |     ✗     | `N/A`           | A ProposeAttributeRequestItem can only be used to propose the creation of RelationshipAttributes that exist in the context of the Relationship between the Sender and the Recipient. For this reason, proposing a RelationshipAttribute to the Recipient that is owned by a third party is not possible.                                                      |
