...
All details on how to use the FormFieldRequestItem and examples of use cases for it can be found in the [Use Form Fields in Requests]({% link _docs_integrate/use-form-fields-in-requests.md %}) scenario documentation.
