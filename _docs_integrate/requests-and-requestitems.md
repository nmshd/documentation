...
Examples of use cases for the ShareAttributeRequestItem can be found in the [Share own Attribute to peer]({% link _docs_integrate/share-attribute-with-peer.md %}) guide.
...
[Combinations and usage scenarios of the ShareAttributeRequestItem]({% link _docs_integrate/share-attribute-with-peer.md %}#combinations-and-usage-scenarios-of-shareattributerequestitem) can be found in the [Share own Attribute to peer]({% link _docs_integrate/share-attribute-with-peer.md %}) guide.
