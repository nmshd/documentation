...
Depending on whether an IdentityAttribute or a RelationshipAttribute has been shared by the Sender, it is referred to as either a [PeerIdentityAttribute]({% link _docs_integrate/attribute-introduction.md %}#own-shared-and-peeridentityattributes) or a [ThirdPartyRelationshipAttribute]({% link _docs_integrate/attribute-introduction.md %}#thirdpartyrelationshipattributes).
