...
| --------------------- | ----------- | :----------------------------------------: | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| IdentityAttribute     | Sender      |                     ✓                      | `AUTO_ACCEPT`   | Example: A company sends a new customer the address of the company.                                                                                                                                                                                                                                                                                             |
| IdentityAttribute     | Recipient   |                     ✗                      | `N/A`           | It makes no sense to share the IdentityAttribute with the Recipient, because it already owns it.                                                                                                                                                                                                                                                                |
| IdentityAttribute     | Third party |                     ✗                      | `N/A`           | You cannot share an IdentityAttribute of which you are not the `owner`.                                                                                                                                                                                                                                                                                         |
| IdentityAttribute     | `<empty>`   |                     ✓                      | `AUTO_ACCEPT`   | Specifying an empty string for the `owner` of the IdentityAttribute is equivalent to requesting the sharing of an IdentityAttribute with the Sender as its `owner`.                                                                                                                                                                                             |
| RelationshipAttribute | Sender      | ✓ or ✗ -<br>depending on `confidentiality` | `USER_DECISION` | The Sender can share RelationshipAttributes of any Relationship that are owned by itself with the Recipient if their `confidentiality` is not `"private"`.<br>Example: A customer shares their customer ID from company A with company B, whereby the customer is the `owner` of the corresponding RelationshipAttribute.                                       |
| RelationshipAttribute | Recipient   |                     ✗                      | `N/A`           | It makes no sense to share the RelationshipAttribute with the Recipient, because it already owns it.                                                                                                                                                                                                                                                            |
| RelationshipAttribute | Third party | ✓ or ✗ -<br>depending on `confidentiality` | `USER_DECISION` | The Sender can share RelationshipAttributes of any Relationship that are owned by a third party with the Recipient if their `confidentiality` is not `"private"`.<br> Example: A customer shares their customer ID from company A with company B, whereby company A is the `owner` of the corresponding RelationshipAttribute. For example, the Payback number. |
| RelationshipAttribute | `<empty>`   |                     ✓                      | `AUTO_ACCEPT`   | Specifying an empty string for the `owner` of the RelationshipAttribute is equivalent to requesting the sharing of a RelationshipAttribute with the Sender as its `owner`.                                                                                                                                                                                      |
