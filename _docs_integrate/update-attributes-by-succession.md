...
We refer to the LocalAttribute of the `owner` as **OwnRelationshipAttribute** and to the peer's LocalAttribute as **PeerRelationshipAttribute**.
...
Doing so, a new version of the OwnRelationshipAttribute will be created at your side.
