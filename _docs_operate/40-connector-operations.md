...
permalink: /operate/connector-operations
toc: true
---
...
You can check the log using `docker logs <your-container-name>` or by checking the [mounted log files]({% link _docs_operate/10-connector-installation.md %}#log-file-mounting)
