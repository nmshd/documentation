...
[Succeeding an own RelationshipAttribute]({% link _docs_integrate/succeed-attribute-to-update-its-value.md %}#succeeding-own-relationshipattributes), a new [LocalAttribute]({% link _docs_integrate/data-model-overview.md %}#localattribute) with the updated `content` will be created at your side.
