...
properties:
  ...
  - api_route_regex:
  - published:
  - link: consumption/succeed-a-relationshipattribute-and-notify-peer
  - redirect_from:
require:
required_by:
---

{% include use-cases/use-case-consumption-succeed-a-relationshipattribute-and-notify-peer.md %}
