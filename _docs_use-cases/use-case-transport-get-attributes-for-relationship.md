...
Retrieve all [LocalAttributes]({% link _docs_integrate/data-model-overview.md %}#localattribute) that are related to the given [Relationship]({% link _docs_integrate/data-model-overview.md %}#relationship) `id`.
