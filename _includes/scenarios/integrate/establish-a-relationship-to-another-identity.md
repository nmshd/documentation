...
You have learned so far how to create a RelationshipTemplate on the Templator and make it available to other Identities. How another Identity, the so-called Requestor, can use it to send a Relationship Request and finally establish a Relationship to the Templator is explained in the next steps.
