...
| Identity       | `<empty>`       |     ✓     | `USER_DECISION` | An empty owner defaults to an Attribute with `owner=<Recipient>`.<br>Example: Company sends name and address to new customer during its onboarding process.                                                                                                                                                                                                                                                                    |
