...
- **platformClientId** `required`
  ...
  The client id is required to communicate with the Enmeshed platform. It can be acquired from the [Enmeshed Support]({% link _docs_scenarios/scenario-sc77.md %}#support).

- **platformClientSecret** `required`

  The client secret is required to communicate with the Enmeshed platform. It can be acquired from the [Enmeshed Support]({% link _docs_scenarios/scenario-sc77.md %}#support).
...
#### amqpPublisher <a href="{% link _docs_scenarios/scenario-sc80.md %}#amqppublisher"><i class="fas fa-fw fa-info-circle"/></a> {#amqppublisher}
...
#### autoAcceptRelationshipCreationChanges <a href="{% link _docs_scenarios/scenario-sc80.md %}#autoacceptrelationshipcreationchanges"><i class="fas fa-fw fa-info-circle"/></a> {#autoacceptrelationshipcreationchanges}
...
#### coreHttpApi <a href="{% link _docs_scenarios/scenario-sc80.md %}#corehttpapi"><i class="fas fa-fw fa-info-circle"/></a> {#corehttpapi}
...
#### sync <a href="{% link _docs_scenarios/scenario-sc80.md %}#sync"><i class="fas fa-fw fa-info-circle"/></a> {#sync}
...
#### webhooksV2 <a href="{% link _docs_scenarios/scenario-sc80.md %}#webhooksv2"><i class="fas fa-fw fa-info-circle"/></a> {#webhooksv2}
...
You can find type definitions of the event data in the [Connector Events]({% link _docs_scenarios/scenario-sc43.md %}) section.

## Troubleshooting

If you encounter any problems while configuring the Connector, head over to the [Troubleshooting]({% link _docs_scenarios/scenario-sc81.md %}) site.
