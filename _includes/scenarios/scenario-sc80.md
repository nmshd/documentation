...
### AMQP Publisher <a href="{% link _docs_scenarios/scenario-sc79.md %}#amqppublisher"><i class="fas fa-fw fa-cog"/></a> {#amqppublisher}
...
### Auto Accept Relationship Creation Changes <a href="{% link _docs_scenarios/scenario-sc79.md %}#autoacceptrelationshipcreationchanges"><i class="fas fa-fw fa-cog"/></a> {#autoacceptrelationshipcreationchanges}
...
### Core HTTP API <a href="{% link _docs_scenarios/scenario-sc79.md %}#corehttpapi"><i class="fas fa-fw fa-cog"/></a> {#corehttpapi}

This Module contains the HTTP API with all Enmeshed base functionalities.

### Sync <a href="{% link _docs_scenarios/scenario-sc79.md %}#sync"><i class="fas fa-fw fa-cog"/></a> {#sync}
...
### WebhooksV2 <a href="{% link _docs_scenarios/scenario-sc79.md %}#webhooksv2"><i class="fas fa-fw fa-cog"/></a> {#webhooksv2}
...
For this, the Connector supports the configuration of webhooks which are called every time a specific [Connector Event]({% link _docs_scenarios/scenario-sc43.md %}) is triggered (e.g. a new Message has been received => `transport.messageReceived`).
