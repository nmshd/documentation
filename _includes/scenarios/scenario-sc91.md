All the RequestItems listed below inherit from the [RequestItem]({% link _docs_scenarios/scenario-sc90.md %}#requestitem) and are therefore sharing its properties.
...
| `query` | [`IdentityAttributeQuery`]({% link _docs_scenarios/scenario-sc90.md %}#identityattributequery) \| [`ThirdPartyRelationshipAttributeQuery`]({% link _docs_scenarios/scenario-sc90.md %}#thirdpartyrelationshipattributequery) | The structured query of the Attribute the sender would like to query. |
