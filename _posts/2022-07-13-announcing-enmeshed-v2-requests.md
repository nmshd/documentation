...
Requests in Enmeshed always defined a way to exchange structured data. In Enmeshed V1 this was exclusively about Attributes. Requests in V2 will also be able to exchange unstructured data without persisting it to the User's Attributes. One example is a form you can send to a User, which contains some questions in natural language.
